...
function Header({title, categories}:Props) {
    ...
    return (
        <header className=" bg-indigo-100  w-full h-1/6 p-5 transition-colors hover:bg-indigo-200 sticky top-0">
            ...
            <Link to="/react-shop-app/shopping-cart" className="fixed right-10 top-8 flex items-center space-x-2 bg-indigo-300 hover:bg-indigo-400 hover:shadow-2xl p-2 rounded-full transition-all">
